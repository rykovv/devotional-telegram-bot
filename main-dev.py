...
COUNTRY, TIME, DEVOTIONAL = range(3)

def start(update: Update, context: CallbackContext) -> int:
    """Starts the conversation and asks the user about their country."""

    update.message.reply_text(
        'Hola! Soy el bot del ministerio de Una Mirada de Fe y Esperanza. '
        ...
        '¿De dónde es Usted? Por ejemplo Estados Unidos, Chile...'
    )
...
def country(update: Update, context: CallbackContext) -> int:
    ...
    user = update.message.from_user
    print("Country of {}: {}".format(user.first_name, update.message.text))
